...
# def imagepredict_api():
#     '''
#     For direct API calls trought request
#     '''
#     data = request.files['image']
#     filename = 'static/images/' + secure_filename(data.filename)
#     data.save(os.path.join(filename))
#     print('Image uploaded successfully')
#     output = predict(model, filename)
#     output = output.replace(':', '')
#     output = output.split(' ')
#     print(output)
#     output = {
#         output[0]: output[1],
#         output[2]: float(output[3])
#     }
...
@app.route('/predicturl_api', methods=['POST'])
def predicturl_api():
    '''
    For direct API calls trought request
    '''
